//
//  ScondeStepProfileHostController+ImagePickerDelegate.swift
//  Tugo
//
...
extension ScondeStepProfileHostController:UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    
    //Alert option for changing photo
    func showInputDialog() {
        //Creating UIAlertController and
        //Setting title and message for the alert dialog
        let alertController = UIAlertController(title: "Subir", message: "¿Deseas subir una imagen de tu documento?", preferredStyle: .alert)
        
        //the confirm action taking the inputs
        let confirmAction = UIAlertAction(title: "Subir", style: .default) { (_) in
    ...
    func changeImage(){
        ...
        print(imageName)
        let storedImage = storage.child("documents").child(imageName)
