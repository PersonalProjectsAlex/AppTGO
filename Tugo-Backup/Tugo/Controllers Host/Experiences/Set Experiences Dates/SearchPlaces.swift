...
class SearchPlacesHost: UIViewController,UISearchBarDelegate,MKMapViewDelegate {
...
extension SearchPlacesHost: GooglePlacesAutocompleteViewControllerDelegate {
